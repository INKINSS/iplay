...
const MainCard = ({playlist}: {playlist: Playlist}) => {
  return (
    <article className="gap-2 overflow-hidden relative group w-40 rounded-sm mt-1 hover:bg-zinc-800 px-2 py-4 cursor-pointer transition-all duration-150 ease-in-out">
