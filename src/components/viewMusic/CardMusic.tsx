...
const CardMusic = ({song}: {song: Song}) => {
  ...
  return (
    <a className="flex-shrink-0 relative gap-2 group w-40 rounded-sm hover:bg-zinc-800 px-2 py-4 cursor-pointer transition-all duration-150 ease-in-out" onClick={handleClick}>
